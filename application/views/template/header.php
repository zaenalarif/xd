...
<?php if($this->session->userdata('level') == "admin"){ ?>
        ...
        <li class="active">
          <a href="<?= base_url('admin') ?>">
            <i class="fa fa-cubes"></i> <span>Data Siswa</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
      <li><a href="<?= base_url('admin/pegawai') ?>" class="active"><i class="fa fa-circle-o"></i>Siswa</a></li>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('laporan/laporan_pegawai'); ?>"><i class="fa fa-circle-o"></i> Data Siswa</a></li>
